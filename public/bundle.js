...
/***/ function(module, exports, __webpack_require__) {
	...
	for (var i = 0; i < 101; i++) {
	  b++;
	  if (b === 20) {
	    store.dispatch((0, _index3.REMOVE_NUMBER)());
	    b = 0;
	  }
	  store.dispatch((0, _index3.ADD_NUMBER)());
	}
...
/***/ function(module, exports) {
	...
	var add = exports.add = 'ADD_NUMBER';
	var remove = exports.remove = 'REMOVE_NUMBER';

	var counter = exports.counter = {
	  check: 0
	};
	var ADD_NUMBER = exports.ADD_NUMBER = function ADD_NUMBER(check) {
	  return {
	    type: add, check: check
	  };
	};

	var REMOVE_NUMBER = exports.REMOVE_NUMBER = function REMOVE_NUMBER(check) {
	  return {
	    type: remove, check: check
	  };
	};
